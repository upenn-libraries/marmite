class CombinedParser
  ...
  def self.parseXLSX(xlsx_filename)
    header_map = ["ABSTRACT","CONTRIBUTOR","COVERAGE","CREATOR","DATE","DESCRIPTION","FORMAT","IDENTIFIER","INCLUDES","LANGUAGE","PUBLISHER","RELATION","RIGHTS","SOURCE","SUBJECT","TITLE","INCLUDES COMPONENT","INCLUDES_COMPONENT","OBJECT TYPE","OBJECT_TYPE","FILENAME(S)","UNIQUE IDENTIFIER","UNIQUE_IDENTIFIER","COLLECTION NAME","COLLECTION_NAME","CONTRIBUTING INSTITUTION","CONTRIBUTING_INSTITUTION"]
